...
public class ApplicationConfig {
    ...
    public static void configuration(JavalinConfig config) {
        ...
        config.bundledPlugins.enableRouteOverview("/routes", User.Role.ANYONE);
    ...
    public static Javalin startServer(int port) {
        ...
        app.beforeMatched(SecurityController.getInstance().authenticate());
        app.beforeMatched(SecurityController.getInstance().authorize());
